...
const ResponseManager = require('./responseManager.metrics.js');
const MetricsManager = require('./metricsManager.metrics.js');
...
describe('ResponseManager', function() {
    ...
    describe('#respond', function() {
        ...
        it('should return 200 response with valid api request path and successful library response', function(done) {
            ...
            sandbox.stub(Auth, 'getUserClaimTicket').resolves(_ticket);
            sandbox.stub(MetricsManager.prototype, 'getMetrics').resolves(_resp);
        ...
        it('should return error response with valid api request path and library error', function(done) {
            ...
            const _resp = {
                ...
                message: `The metrics for user ${_ticket.userid} does not exist.`
            };

            sandbox.stub(Auth, 'getUserClaimTicket').resolves(_ticket);
            sandbox.stub(MetricsManager.prototype, 'getMetrics').rejects(_resp);
